...
var DM_MyTradeList = function(){
    ...
    this._template= 
	    ...
	    '            <p class="txt12"><span class="fl">本期参与：{{joinCount}}人次</span><span class="fr lanse" ontouchstart="dfh_touch()" onclick="openUserTradeCodes(getUserId(), {{tradeno}})">参与详情</span></p> '+
	    '        </div> '+
	    '      </div> '+	    
	    '    </div> '+
